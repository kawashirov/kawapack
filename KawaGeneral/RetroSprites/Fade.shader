Shader "Kawashirov/Retro Sprites Fade" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
			...
			#pragma surface surf Sprite vertex:vert alpha:fade exclude_path:deferred exclude_path:prepass nometa nolightmap fullforwardshadows
