Shader "Kawashirov/Flat Lit Toon/Cutout VHDGF (Tessellation+Geometry)" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			// #pragma shader_feature _ EMISSION_CUSTOM EMISSION_MAIN
			...
			#pragma skip_variants INSTANCING_ON LIGHTMAP_ON DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_SHADOW_MIXING
