...
#if defined(FRAGMENT_IN) && defined(KAWAFLT_PASS_FORWARDBASE)
...
#endif // defined(FRAGMENT_IN) && defined(KAWAFLT_PASS_FORWARDBASE)

#if defined(FRAGMENT_IN) && defined(KAWAFLT_PASS_FORWARDADD)
...
#endif // defined(FRAGMENT_IN) && defined(KAWAFLT_PASS_FORWARDADD)
